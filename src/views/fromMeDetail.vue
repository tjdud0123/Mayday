  ...
  <div id="FromMeDetail">
    ...
    <div class="hashTag center">
        <div class="centerBox center">
            ...
            <div class="hashText center">{{reply.tag}} </div>
        </div>
    </div>
    ...
    <div class="reply center">
        ...
        <div class="replyField">{{reply.replyText}}</div>
        <div class="rePlyDown">
            <div class="likeBox center" v-bind:style="{display:getText(reply.replyLike)}">
                <img class="like" src="css/letterDetail/reply_give_heart_af.png">
                당신의 답장에 위로를 받았습니다.</div>
        </div>
    </div>
...
export default {
  ...
  data: function() {
      let vm =this;
        return {
           hamOn:"none",
           reply: this.$root.Replys.filter(function (reply) { return (reply.lpk == vm.$route.params.LetterId && reply.rpk == vm.$route.params.ReplyId) })[0],
        }
    },
    methods:{
      hamAct: function(){
