<template>
  <div id="ToMe">
    ...
    <div class="topContainer center">
        ...
        <div class="title center">나에게 온 답장</div>
    ...
    <div class="listContainer">
        <div class="outContainer" v-for="(item, i) in $root.Replys" v-bind:key="i">
            <div class="list center aftRead" v-if="($root.Letters[item.lpk].id == $root.currentInfo.id)" v-on:click="goTo(item.lpk, item.rpk)">
    ...
    <div class="hamburgerBox">
        ...
        <div class="hamSelect">
            <div class="hamMsgBox">
                ...
                <div class="selectMenu Menu3" v-on:click="hamClose">나에게 온 답장</div>
            </div>
            <div class="hamActBox">
...
export default {
  ...
  data: function() {
    ...
    methods:{
        ...
        goTo:function(lidx, ridx){
         
          this.$router.push({name: 'MyLetterDt', params: {LetterId : lidx, ReplyId:ridx}})
        }
